...
<div class="container-fluid">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form class="form-inline">
                ...
                <?php if (count($gaji) > 0) { ?>
                    <a href="<?php echo base_url('admin/dataPenggajian/cetakGaji?bulan = ' . $bulan), '&tahun = ' . $tahun ?>" class="btn btn-primary mb-2 ml-auto"><i class="fas fa-print"></i> Cetak Daftar Gaji</a>
                <?php } else { ?>
                    <button type="button" class="btn btn-primary mb-2 ml-auto" data-toggle="modal" data-target="#exampleModal">
    ...
    <?php } else { ?>
        <span class="badge badge-danger" style="font-size: 15px;"><i class="fas fa-info-circle" style="font-size: 20px;"></i> Data absensi kosong, silahkan input data kehadiran pada bulan dan
            tahun yang anda pilih.</span>
    <?php } ?>
</div>
